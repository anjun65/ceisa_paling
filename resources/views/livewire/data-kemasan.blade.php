            ...
            <div class="flex-col space-y-4">
                <x-table>
                    <x-slot name="head">
                        ...
                        <x-table.heading sortable multi-column wire:click="sortBy('merek')" :direction="$sorts['merek'] ?? null">Merk Kemasan</x-table.heading>
    ...
    <form wire:submit.prevent="save">
        <x-modal.dialog wire:model.defer="showEditModal">
            ...
            <x-slot name="content">
                ...
                <x-input.group for="merek" label="Merk Kemasan" :error="$errors->first('editing.merek')">
                    <x-input.text wire:model="editing.merek" id="merek" placeholder="Merk Kemasan" />
                </x-input.group>
            </x-slot>
