        ...
        <div class="flex-col space-y-4">
            <x-table>
                <x-slot name="head">
                    ...
                    <x-table.heading sortable multi-column wire:click="sortBy('jenis_dokumen')" :direction="$sorts['jenis_dokumen'] ?? null">Jenis PPFTZ</x-table.heading>
                    ...
                    <x-table.heading sortable multi-column wire:click="sortBy('nama_pemilik')" :direction="$sorts['nama_pemilik'] ?? null">Pengirim</x-table.heading>
                    <x-table.heading sortable multi-column wire:click="sortBy('nama_pengirim')" :direction="$sorts['nama_pengirim'] ?? null">Penerima</x-table.heading>
                    <x-table.heading sortable multi-column wire:click="sortBy('jalur')" :direction="$sorts['jalur'] ?? null">Jalur</x-table.heading>
    ...
    <form wire:submit.prevent="save">
        <x-modal.dialog wire:model.defer="showEditModal">
            ...
            <x-slot name="content">
                ...
                <x-input.group for="kantor_pabean" label="Diajukan di Kantor:" :error="$errors->first('editing.kantor_pabean')">
                    <x-input.select wire:model="editing.kantor_pabean" id="kantor_pabean">
                        <option value="" selected>Belum Memilih</option>
