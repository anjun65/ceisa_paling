...
use App\Models\DokumenLain as DokumenLainModel;
...
class DataDokumen extends Component
{
    ...
    public DokumenLainModel $editing;
    public $upload;
    ...
    {
        return DokumenLainModel::make(['date' => now(), 'status' => 'success']);
    }
    ...
    public function edit(DokumenLainModel $transaction)
    {
        $this->useCachedRows();
