...
class CreateDokumenPabean extends Component
{
    ...
    public $showPetiKemasEditModal = false;
    public $showDataKemasanEditModal = false;
    ...
    public function createpetikemas()
    {

        $this->showPetiKemasEditModal = true;
    }

    public function createdatakemasan()
    {

        $this->showDataKemasanEditModal = true;
    }
    ...
    public function save()
    {
        ...
        $this->dokumenlain->fill([
            ...
            'upload_dokumen' => $this->upload->store('data_dokumen'),
        ]);
